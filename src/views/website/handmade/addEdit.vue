      ...
      <el-card shadow="hover" class="el-col el-col-24">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px">
              ...
              <el-form-item label="名称:">
                <el-input v-model="ruleForm.title" placeholder="输入标题" class="input-width5"></el-input>
              </el-form-item>
              <el-form-item label="关键词:">
                <el-input v-model="ruleForm.keywords" placeholder="输入关键词,用‘,’隔开" class="input-width5"></el-input>
              </el-form-item>
              <el-form-item label="url:" prop="url" required>
                <el-input v-model="ruleForm.url" :placeholder="placeholder" class="input-width5"></el-input>
              </el-form-item>
              <el-form-item label="图片:" prop="cover" required v-if="this.isHidden == false">
                  <el-upload
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.sname == '热装楼盘'){
        this.placeholder = '请输入楼盘链接';
      }
      if(this.sname == '速美案例' || this.sname == '推荐案例'){
        this.placeholder = '请输入案例链接';
      }
      if(this.sname == '速美案例' || this.sname == '推荐案例' || this.sname == '精选案例' || this.sname == '热装楼盘'){
        this.isHidden = true;
      }
      //图片上传地址
          ...
          if (valid) {
            ...
            if(this.stype == "编辑"){
              edithandModeDataList(this.id,this.ruleForm).then(res => {
                ...
                this.$router.push({ name:'手工模块管理1', params:{name: this.sname, id: this.sid} }) 
              });
            }else{
              //新增接口
