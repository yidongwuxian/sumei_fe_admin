<template>
  <div class="tabs-view-container">
    <router-link style="line-height:40px;margin-right:10px;" class="tags-view-item" :class="isActive(tag) ? 'active' : '' " v-for="(tag, index) in visitedTabsView" :to="tag.path" :key="index">
      <el-tag
        closable
